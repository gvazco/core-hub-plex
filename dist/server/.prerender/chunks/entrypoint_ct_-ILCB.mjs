...
import { c as createActionsProxy, p as pipelineSymbol, A as AstroError, a as ActionCalledFromServerError, d as defineAction } from './prerender_Hd2AncPp.mjs';
...
const contact = {
  sendEmail: defineAction({
    ...
    handler: async (input) => {
      const url = `${"https://core-cms.core-hub-plex.cloud"}/wp-json/contact-form-7/v1/contact-forms/158/feedback`;
