...
import 'piccolore';
import { m as maybeRenderHead, r as renderComponent, b as renderTemplate, u as unescapeHTML } from './prerender_Hd2AncPp.mjs';
import { h as DirectusContactPageResponseSchema } from './index_Bh7jurQE.mjs';
import 'clsx';
...
const $$Contacto = createComponent(async ($$result, $$props, $$slots) => {
  const url = `${"https://core-cms.core-hub-plex.cloud/items"}/pages?filter[slug][_eq]=contacto`;
