import { c as createComponent } from './_astro_assets_B3_jlX6-.mjs';
import 'piccolore';
import { k as createRenderInstruction, h as addAttribute, f as renderTemplate, m as maybeRenderHead, j as renderComponent, l as renderHead, n as renderSlot, o as renderTransition, q as fade, s as slide } from './server_DqJmoyYZ.mjs';
import 'clsx';
import { z } from 'zod';
...
const $$CoreLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Core Hub Plex</title><meta property="og:image" content="/fijacion.webp"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Syne:wght@400;700;800&family=JetBrains+Mono:wght@400;700&display=swap" rel="stylesheet">${renderComponent($$result, "ClientRouter", $$ClientRouter, {})}${renderHead()}</head> <body class="antialiased selection:bg-neon-pink selection:text-white"> ${renderComponent($$result, "CoreHeader", $$CoreHeader, { "data-astro-transition-scope": renderTransition($$result, "vlvjktsg", fade({ duration: ".5s" })) })} <main class="bg-dark max-w-7xl mx-auto lg:-mt-20 relative"> <div${addAttribute(renderTransition($$result, "xgoelquk", slide({ duration: "1s" })), "data-astro-transition-scope")}> ${renderSlot($$result, $$slots["default"])} </div> </main> ${renderSlot($$result, $$slots["after-main-content"])} ${renderComponent($$result, "CoreFooter", $$CoreFooter, { "data-astro-transition-scope": renderTransition($$result, "tcy5et5r", fade({ duration: ".5s" })) })} ${renderScript($$result, "/home/gustavovazco/Documentos/DEV/Core-Hub-Plex/core-hub-plex/src/layouts/CoreLayout.astro?astro&type=script&index=0&lang.ts")}</body></html>`;
