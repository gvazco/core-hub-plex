...
import 'piccolore';
import { m as maybeRenderHead, f as addAttribute, h as renderTemplate, j as renderComponent, u as unescapeHTML } from './server_BIsboIgl.mjs';
import { D as DirectusArticlesCollectionSchema, $ as $$CoreLayout } from './index_mUWhIiON.mjs';
import 'clsx';
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const newsRes = await fetch(
    `${undefined                         }/articles?filter[slug][_eq]=${slug}&fields=*,article_category.*,article_tags.*,author.*`
  );
