...
import 'piccolore';
import { m as maybeRenderHead, f as renderTemplate, h as addAttribute, j as renderComponent, u as unescapeHTML } from './server_DqJmoyYZ.mjs';
import { P as PostSchema, $ as $$CoreLayout } from './index_CG7Uj91m.mjs';
import 'clsx';
...
Publicado el: <span class="text-neon-cyan">${formatDate(date)}</span> </p>`;
