import { c as createComponent } from './_astro_assets_BJeqnASL.mjs';
import 'piccolore';
import { k as createRenderInstruction, f as addAttribute, h as renderTemplate, m as maybeRenderHead, j as renderComponent, l as renderHead, n as renderSlot, o as renderTransition, q as fade, s as slide } from './server_QTqHSXU2.mjs';
import 'clsx';
import { z } from 'zod';
...
const $$CoreLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>${title} | ${subtitle}</title><meta name="description"${addAttribute(subtitle, "content")}><meta property="og:image"${addAttribute(bgImage, "content")}><link rel="icon" type="image/svg+xml" href="/favicon.ico"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@300..700&family=Space+Mono:ital,wght@0,400;0,700;1,400;1,700&family=Syne:wght@400;700;800&display=swap" rel="stylesheet"><link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined" rel="stylesheet"><link rel="stylesheet" href="https://unpkg.com/aos@next/dist/aos.css">${renderComponent($$result, "ClientRouter", $$ClientRouter, {})}${renderHead()}</head> <body class="antialiased selection:bg-neon-pink selection:text-white"> ${renderComponent($$result, "CoreHeader", $$CoreHeader, { "data-astro-transition-scope": renderTransition($$result, "mqz7c4mk", fade({ duration: ".5s" })) })} <main class="bg-dark max-w-5xl mx-auto px-5 md:px-0 relative"> <div${addAttribute(renderTransition($$result, "6hfyrt5x", slide({ duration: "1s" })), "data-astro-transition-scope")}> ${renderSlot($$result, $$slots["default"])} </div> </main> ${renderSlot($$result, $$slots["after-main-content"])} ${renderComponent($$result, "CoreFooter", $$CoreFooter, { "data-astro-transition-scope": renderTransition($$result, "zvpra6vx", fade({ duration: ".5s" })) })} ${renderComponent($$result, "LoadingOverlay", $$LoadingOverlay, {})} ${renderScript($$result, "/home/gustavovazco/Documentos/DEV/Core-Hub-Plex/core-hub-plex/src/layouts/CoreLayout.astro?astro&type=script&index=0&lang.ts")} </body> </html>`;
