...
const assetQueryParams = undefined;
					const imageConfig = {"endpoint":{"entrypoint":"astro/assets/endpoint/node","route":"/_image"},"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":["api-core-hub-plex.local","api-panel.core-hub-plex.cloud"],"remotePatterns":[],"responsiveStyles":false};
